...
namespace Marketplace.SaaS.Accelerator.DataAccess.Migrations
{
    ...
    [Migration("20260806093506_AddSubscriptionIsFreeTrial")]
    partial class AddSubscriptionIsFreeTrial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marketplace.SaaS.Accelerator.DataAccess.Entities.NotificationOutbox", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Marketplace.SaaS.Accelerator.DataAccess.Entities.SubscriptionSite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("DowngradedUtc")
                        .HasColumnType("datetime");
                    ...
                    b.Property<string>("GrantedByUpn")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");
                    ...
                    b.ToTable("SubscriptionSite");
                });

            modelBuilder.Entity("Marketplace.SaaS.Accelerator.DataAccess.Entities.SubscriptionTenantConsent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AzureRegionSelectedByUpn")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");

                    b.Property<DateTime?>("AzureRegionSelectedUtc")
                        .HasColumnType("datetime");

                    b.Property<string>("ConsentedByObjectId")
                        .HasMaxLength(64)
                        .IsUnicode(false)
                        .HasColumnType("varchar(64)");

                    b.Property<string>("ConsentedByUpn")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");
                    ...
                    b.Property<string>("FanOutFailureRegions")
                        .HasMaxLength(2000)
                        .IsUnicode(false)
                        .HasColumnType("varchar(2000)");

                    b.Property<int?>("MeteredUserThreshold")
                        .HasColumnType("int");

                    b.Property<DateTime?>("ModifiedUtc")
                        .HasColumnType("datetime");

                    b.Property<DateTime?>("RuntimeAppConsentedUtc")
                        .HasColumnType("datetime");

                    b.Property<DateTime?>("TeamsActivityAppConsentedUtc")
                        .HasColumnType("datetime");

                    b.Property<string>("TeamsActivityConsentedByObjectId")
                        .HasMaxLength(64)
                        .IsUnicode(false)
                        .HasColumnType("varchar(64)");

                    b.Property<string>("TeamsActivityConsentedByUpn")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");
                    ...
                    b.Property<DateTime?>("TenantRegionsFanOutCompleteUtc")
                        .HasColumnType("datetime");
                    ...
                    b.ToTable("SubscriptionTenantConsent");
                });
            ...
            modelBuilder.Entity("Marketplace.SaaS.Accelerator.DataAccess.Entities.WebhookCapture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WebhookCapture");
                });

            modelBuilder.Entity("Marketplace.SaaS.Accelerator.DataAccess.Entities.WebhookOperationLog", b =>
                {
                    b.Property<Guid>("OperationId")
                        .HasColumnType("uniqueidentifier");
